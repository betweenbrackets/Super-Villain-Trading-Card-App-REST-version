...
# --- routes ---
# --- this route returns all the villains to the app ---
...
def add_villain():
  ...
  if errors:
    ...
    new_villain = Villain(name=name,description=description, interests=interests,
    url=url)
...
def get_endpoints():
  endpoints = {
    # --- key value pair ---
    # --- key defines endpoint ---
    # --- value explains HTTP method and the result of calling that method --- 
